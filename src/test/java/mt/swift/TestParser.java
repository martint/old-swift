...
import mt.swift.parser.ThriftLexer;
import mt.swift.parser.ThriftParser;
...
public class TestParser
{
	public void testParser()
		throws Exception
	{
		ThriftLexer lexer = new ThriftLexer(new ANTLRFileStream("src/test/java/mt/swift/TSimple.thrift"));
...
//		while (t.getType() != Token.EOF);
	...
	public void testParserComplex()
		throws Exception
	{
		ThriftLexer lexer = new ThriftLexer(new ANTLRFileStream("src/test/java/mt/swift/tutorial.thrift"));
