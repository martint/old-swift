 ...
 * taken care of. As long as references are published in a thread-safe manner, deserialize() can be called without
 ...
 *  ...
 *
 *  volatileReference = deserializer;
 *
 * Thread 2:
 *   Deserializer deserializer = volatileReference;
...
public class Deserializer
{
    ...
    private final Map<String, StructureDeserializer<?>> deserializers = new HashMap<String, StructureDeserializer<?>>();
    ...
    public void bind(StructureType type, Class clazz)
    {
        ...
        StructureDeserializer<?> deserializer = compileDeserializer(type, clazz);
        deserializers.put(type.getName(), deserializer);
    }
...
//			writer = new TraceClassVisitor(writer, new PrintWriter(System.out));
        ...
        String deserializerClassName =
                "mt/swift/generated/Deserializer" + clazz.getSimpleName() + "_" + sequence++;
